    ...
    if (max > pages) {
      ...
      items.push(
        <PaginationItem key={"first"}>
          <PaginationLink
            href="#"
            onClick={(e) => this.onChange(e, previous, limit)}
          >
            &lt;
          </PaginationLink>
        </PaginationItem>
    ...
    for (let i = start; i < start + pages; i++) {
      items.push(
        <PaginationItem active={i === page} key={i}>
          <PaginationLink href="#" onClick={(e) => this.onChange(e, i, limit)}>
            {i}
          </PaginationLink>
        </PaginationItem>
      );
    ...
    if (max > pages) {
      ...
      items.push(
        <PaginationItem key={"last"}>
          <PaginationLink
            href="#"
            onClick={(e) => this.onChange(e, next, limit)}
          >
            &gt;
          </PaginationLink>
        </PaginationItem>
